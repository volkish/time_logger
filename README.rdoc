...
* Fixed styles
* Periodically ajax requests replaced with pure javascript time
* Added functional tests

![Preview](http://git.red-soft.biz/red2mine/time_logger/-/blob/41516d258daaaabcf6813761c452d670fde87799/1552138058249.gif)
...
<tt>bundle exec bin/rails redmine:plugins:test NAME=time_logger RAILS_ENV=test</tt>
